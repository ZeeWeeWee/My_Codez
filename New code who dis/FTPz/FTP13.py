...
class FTPClientGUI:
    ...
    def create_file_browser_window(self):
        ...
        # Store the file browser window as a class attribute
        ...
        #file_browser_window.protocol("WM_DELETE_WINDOW", self.on_file_browser_close)
    ...
    # Reopen the main window and close the file browser window
    ...
    def disconnect_from_ftp(self):
        ...
        # Close the file browser window and reopen the main window
