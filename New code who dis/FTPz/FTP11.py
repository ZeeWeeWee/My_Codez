...
class FTPClientGUI:
    ...
    def create_file_browser_window(self):
        ...
        self.file_tree = ttk.Treeview(file_browser_window, selectmode='extended', columns=("Name", "Size", "Last Modified", "Type"), show="headings")
        ...
        self.download_button = ttk.Button(file_browser_window, text="Download Files", command=self.download_files)
        self.download_button.pack(pady=10)

        self.upload_button = ttk.Button(file_browser_window, text="Upload Files", command=self.upload_files)
