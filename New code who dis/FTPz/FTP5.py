...
class FTPClientGUI:
    ...
    def create_file_browser_window(self):
        ...
        self.upload_button = tk.Button(file_browser_window, text="Upload File", command=self.upload_file)
    ...
    def connect_to_ftp(self):
        ...
        if server and username:
            ...
            print("Please enter a valid server and username.")
