...
class FTPClientGUI:
    ...
    def on_tree_item_double_click(self, event):
        ...
        print(f"Selected item: {selected_item}")  # Check the raw selected item
        if selected_item:
            file_name = self.file_tree.item(selected_item)["values"][0]
            print(f"Retrieved file name: {file_name}")  # Check the retrieved file name
        ...
        print(f"Trying to change directory to: {file_name}")
