...
def set_pos2_ip_and_dns():
    primary_ip_address = "192.168.9.21"   # Replace with the desired primary IP address for POS2
    secondary_ip_address = "192.168.9.22"  # Replace with the desired secondary IP address for POS2
    subnet_mask = "255.255.255.0"  # Replace with the desired subnet mask
    default_gateway = "192.168.1.1"  # Replace with the desired default gateway
    dns_servers = ['8.8.8.8', '8.8.4.4']  # Replace with the desired DNS servers
...
def set_pos3_ip_and_dns():
    primary_ip_address = "192.168.9.31"   # Replace with the desired primary IP address for POS3
    secondary_ip_address = "192.168.9.32"  # Replace with the desired secondary IP address for POS3
    subnet_mask = "255.255.255.0"  # Replace with the desired subnet mask
    default_gateway = "192.168.1.1"  # Replace with the desired default gateway
    dns_servers = ['8.8.8.8', '8.8.4.4']  # Replace with the desired DNS servers
